...
class TrainingPipeline:
    ...
    def run_pipeline(self) -> None:
        ...
        try:
            ...
            model_evaluation_artifact: ModelEvaluationArtifact = self.start_model_evaluation(model_trainer_artifact=model_trainer_artifact, data_transformation_artifact=data_transformation_artifact)
