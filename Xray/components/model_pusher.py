...
class ModelPusher:
    ...
    def build_and_push_bento_image(self):
        ...
        try:
            ...
            os.system(
                f"bentoml containerize {self.model_pusher_config.bentoml_service_name}:latest -t 637423613730.dkr.ecr.ap-southeast-2.amazonaws.com/{self.model_pusher_config.bentoml_ecr_image}:latest"
            )
            ...
            os.system(
                "aws ecr get-login-password --region ap-southeast-2 | docker login --username AWS --password-stdin 637423613730.dkr.ecr.ap-southeast-2.amazonaws.com"
            )
            ...
            os.system(
                f"docker push 637423613730.dkr.ecr.ap-southeast-2.amazonaws.com/{self.model_pusher_config.bentoml_ecr_image}:latest"
            )
